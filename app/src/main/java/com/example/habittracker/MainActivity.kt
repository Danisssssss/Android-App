...
class MainActivity : AppCompatActivity() {
    ...
    private val sampleHabits = mutableListOf(
        Habit(++habitIdCounter, "Данис", "Техник 1-ой категории", 5, false),
        Habit(++habitIdCounter, "Шамиль", "Инжерен", 12, true),
        Habit(++habitIdCounter, "Донат", "Аналитик", 3, false),
        Habit(++habitIdCounter, "Давид", "Инженер", 7, true),
    )
