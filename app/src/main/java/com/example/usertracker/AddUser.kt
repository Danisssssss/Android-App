...
class AddUser : AppCompatActivity() {
    ...
    private lateinit var etUserDescription: EditText
    ...
    private fun saveUser() {
        ...
        val description = etUserDescription.text.toString().trim()

        if (name.isEmpty()) {
            Toast.makeText(this, "Введите пользователя", Toast.LENGTH_SHORT).show()
            return
        }
